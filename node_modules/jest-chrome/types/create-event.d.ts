 ...
 */
export declare function createSetEvent<C extends EventCallback, R extends MonotypeEventSelector<C> | EventSelector<C>>(selector: R): CallableEvent<C, R>;
/**
 ...
 */
export declare function createMapEvent<C extends EventCallback, E extends MonotypeEventSelector<C> | EventSelector<C>, O extends OptionsSelector>(eventSelector: E, optionsSelector?: O): CallableEvent<C, E>;
export {};
